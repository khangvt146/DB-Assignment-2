...
exports.getAllLesson = async function() {
    ...
    WHERE bai_giang.ma_kh = khoa_hoc.ma_kh AND bai_giang.ma_gv = giao_vien.id AND khoa_hoc.ma_trinh_do = trinh_do.ma_trinh_do AND giao_vien.id = nguoi_dung.id ORDER BY ma_bai_giang ASC LIMIT 500;`);
};
